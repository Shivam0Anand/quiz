var jsQuestons = [
  {
    question: '<iframe src="https://carbon.now.sh/embed/?bg=rgba(171%2C%20184%2C%20195%2C%201)&t=seti&wt=sharp&l=javascript&ds=true&dsyoff=20px&dsblur=68px&wc=true&wa=false&pv=0px&ph=0px&ln=true&fm=Hack&fs=16.5px&lh=133%25&si=false&es=4x&wm=false&code=function%2520sayHi()%2520%257B%250A%2520%2520console.log(name)%253B%250A%2520%2520console.log(age)%253B%250A%2520%2520var%2520name%2520%253D%2520%2522Lydia%2522%253B%250A%2520%2520let%2520age%2520%253D%252021%253B%250A%257D%250A%250AsayHi()%253B" sandbox="allow-scripts allow-same-origin"></iframe>',
    choiceA: "A: Lydia and undefined",
    choiceB: "B: Lydia and ReferenceError",
    choiceC: "C: ReferenceError and 21",
    choiceD: "D: undefined and ReferenceError",
    correctAnswer : choiceD,
    answer: "Answer: D - 'undefined and ReferenceError'",
    discription: "Within the function, we first declare the name variable with the var keyword. This means that the variable gets hoisted (memory space is set up during the creation phase) with the default value of undefined, until we actually get to the line where we define the variable. We haven't defined the variable yet on the line where we try to log the name variable, so it still holds the value of undefined.",
  ...
  },
  {
    ...
    choiceA:"A: 20 and 62.83185307179586",
    choiceB:"B: 20 and NaN",
    choiceC:"C: 20 and 63",
    choiceD:"D: NaN and 63",
    correctAnswer: choiceB,
    answer: "Answer: B - 'B: 20 and NaN'",
    discription: "Note that the value of diameter is a regular function, whereas the value of perimeter is an arrow function. With arrow functions, the this keyword refers to its current surrounding scope, unlike regular functions! This means that when we call perimeter, it doesn't refer to the shape object, but to its surrounding scope (window for example). There is no value radius on that object, which returns undefined."
  },
  {
